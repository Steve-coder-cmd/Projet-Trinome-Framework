...
public class Vehicule {
   ...
   public Vehicule(String var1, int var2, LocalDateTime var3, int var4) {
      this.idClient = var1;
   ...
   public Vehicule(int var1, String var2, int var3, LocalDateTime var4, int var5) {
      this.id = var1;
      this.idClient = var2;
   ...
   public String toString() {
      ...
      return "Vehicule{id=" + var10000 + ", idClient='" + this.idClient + "', nbPassagers=" + this.nbPassagers + ", dateHeureArrivee=" + String.valueOf(this.dateHeureArrivee) + ", idHotel=" + this.idHotel + "}";
   }
}
